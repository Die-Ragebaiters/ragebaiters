const memberData = {
  "Yotzek (Ben)": { img: "images/benf.png", role: "Teamführer", desc: "Ben ist derjenige, der die Truppe zusammenhält. Er koordiniert große Einheiten effizient und zielgerichtet. Selbst im Gefecht bewahrt er einen kühlen Kopf, trifft klare Entscheidungen und steht seinen Leuten jederzeit unterstützend zur Seite." },
  ...
  "Disccave (Nils)": { img: "images/nils.png", role: "Breacher / OG", desc: "Nils hat die Gruppe zum Airsoft geführt und gehört damit zu den „OGs“. Besonders gut ist er in der Improvisation sowie in der Koordination kleiner Gruppen.." },
